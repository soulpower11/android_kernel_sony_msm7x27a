...
#ifdef CONFIG_LEDS_CHIP_LM3533 /* 20120509-Jordan */
...
/*++ Huize - 20120927 Add pre-define TAG for ATMEL_TOUCH ++*/
...
#endif
/*++ Huize - 20120927 Add endif for mapping ++*/
#endif
/*-- Huize - 20120927 Add endif for mapping --*/
...
/*++ Huize - 20121107 Register sensor device ++*/
...
/*++ Huize - 20120927 Add pre-define TAG for mapping ++*/
#if defined(CONFIG_TOUCHSCREEN_SYNAPTICS_RMI4_I2C) || \
defined(CONFIG_TOUCHSCREEN_SYNAPTICS_RMI4_I2C_MODULE)
/*-- Huize - 20120927 Add pre-define TAG for mapping --*/
...
#endif /* CONFIG_TOUCHSCREEN_SYNAPTICS_RMI4_I2C || CONFIG_TOUCHSCREEN_SYNAPTICS_RMI4_I2C_MODULE*/
...
#endif //CONFIG_TOUCHSCREEN_ATMEL_MAXTOUCH
/*-- Huize - 20120927 Add pre-define TAG for ATMEL_TOUCH --*/

/*++ Huize - 20120927 Create by MelChang ++*/
#ifdef CONFIG_TOUCHSCREEN_CYPRESS_CY8CTMA340
...
static struct msm_handset_platform_data hs_platform_data = {
	.hs_name = "7k_handset",
	//++ Mel. Set delay to 0, default is 500.
